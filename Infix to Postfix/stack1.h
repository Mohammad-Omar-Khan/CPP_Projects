/**
 * @file: stack1
 * @author: Mohammad Omar Khan (2021305)
 * @author: Zaid Dandia (2021719)
 * @brief: Header file containing stack functions to be used in the file CS221-A2-2021305-2021719
 */
#include<iostream>
using namespace std;
